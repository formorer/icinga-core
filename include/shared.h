...
extern char *my_strtok(const char *buffer, const char *tokens);
...
extern void strip(const char *buffer);
...
extern int compare_hashdata(const char *val1a, const char *val1b, const char *val2a,
			    const char *val2b);
extern void get_datetime_string(time_t *raw_time, const char *buffer,
